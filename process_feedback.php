...
$servername = "localhost";  // Change this if different (e.g., your hosting server)
$username = "root";         // MySQL username (usually "root" on local setups)
$password = "";             // MySQL password (empty for local XAMPP installations)
